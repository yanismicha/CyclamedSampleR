...
#' @param saveInCookies si la valeur est "true", les préférences de l'utilisateur sont enregistrées dans un cookie. La valeur par défaut est false.
#' @param label boutton label pour utiliser le mode sombre
#' @param autoMatchOsTheme si la valeur est "true", le thème de couleur correspondra automatiquement aux préférences du système d'exploitation de l'utilisateur. 
#' @import jsonlite
...
#'
#' Charge les fichiers CSS et JS nécessaires pour le mode sombre.
#' @import shiny
#' @return pas de retour
#' @export
#' @author Deepanshu Bhalla
